...
if (getCookie("ST Features").includes("settings-footer")) {
  if (
    ...
    var elements = document
      ...
      .cloneNode(true);
    var elementsappended = document
      .querySelector(
        "#footer > div > ul.clearfix.footer-col > li:nth-child(3) > ul"
      )
...
if (getCookie("ST Features").includes("settings-footer")) {
  if (
    ...
    var elements = document
      .querySelector("#footer > div > div > dl:nth-child(3) > dd:nth-child(5)")
      .cloneNode(true);
    var elementsappended = document
      .querySelector("#footer > div > div > dl:nth-child(3) > dd:nth-child(5)")
      .parentNode.appendChild(elements);
    elementsappended.firstChild.firstChild.textContent =
      "ScratchTools Settings";
    elementsappended.firstChild.href = "https://scratch.mit.edu/ScratchTools/";
  }
}
...
function stufftodo() {
  if (
    document.querySelector(
      "#navigation > div > ul > li.link.right.account-nav > div > ul > li:nth-child(3) > a > span"
    ) !== null ||
    document.querySelector(
      "#topnav > div > div > ul.account-nav.logged-in > li.logged-in-user.dropdown.open > span"
    ) !== null
  ) {
    if (
      document.querySelector(
      ...
      document.querySelector(
        "#topnav > div > div > ul.account-nav.logged-in > li.logged-in-user.dropdown.open > div > ul > li:nth-child(3) > a"
