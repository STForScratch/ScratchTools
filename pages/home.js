...
if (window.location.href === "https://scratch.mit.edu/") {
  ...
  function checkversion() {
    if (getCookie("ScratchToolsVersion") !== "2.4.0") {
      document.cookie =
        "ScratchToolsVersion=2.4.0; expires=Thu, 18 Dec 9999 12:00:00 UTC; path=/";
      createExplanation();
    }
  }
  ...
  function createExplanation() {
    ...
    el2.textContent =
      "Welcome to v2.4.0! We've added multiple new features, including a sidebar!!! Instead of using the basic navigation bar at the top of the screen, you can now use a sidebar!";
  ...
  if (1 === 2) {
    el = document.querySelector(
      "#view > div > div:nth-child(1) > div:nth-child(2)"
    );
    var clone = el.cloneNode(true);
    document
      .querySelector("#view > div > div:nth-child(1)")
      .insertBefore(
        clone,
        document.querySelector(
          "#view > div > div:nth-child(1) > div:nth-child(3)"
        )
      );
    document
      .querySelector(
        "#view > div > div:nth-child(1) > div:nth-child(3) > div.box-content > div > button.slick-arrow.slick-next"
      )
      .remove();
    document
      .querySelector(
        "#view > div > div:nth-child(1) > div:nth-child(3) > div.box-content > div > button.slick-arrow.slick-prev.slick-disabled"
      )
      .remove();
    document.querySelector(
      "#view > div > div:nth-child(1) > div:nth-child(3) > div.box-header > h4"
    ).textContent = "Projects Featured by ScratchTools";

    document.querySelector(
      "#view > div > div:nth-child(1) > div:nth-child(3) > div.box-content > div > div > div > div:nth-child(1) > a > img"
    ).src = "https://uploads.scratch.mit.edu/projects/thumbnails/584015480.png";
    document.querySelector(
      "#view > div > div:nth-child(1) > div:nth-child(3) > div.box-content > div > div > div > div:nth-child(1) > div > div > a"
    ).href = "https://scratch.mit.edu/projects/584015480/";
    document.querySelector(
      "#view > div > div:nth-child(1) > div:nth-child(3) > div.box-content > div > div > div > div:nth-child(1) > div > div > a"
    ).textContent =
      "Pixel Challenge Remake #All #Games #Art #Music #Stories #Animations ";
    document.querySelector(
      "#view > div > div:nth-child(1) > div:nth-child(3) > div.box-content > div > div > div > div:nth-child(1) > div > div > div > a"
    ).src = "https://scratch.mit.edu/users/Nethula_manumitha/";
    document.querySelector(
      "#view > div > div:nth-child(1) > div:nth-child(3) > div.box-content > div > div > div > div:nth-child(1) > div > div > div > a"
    ).textContent = "Nethula_manumitha";

    document.querySelector(
      "#view > div > div:nth-child(1) > div:nth-child(3) > div.box-content > div > div > div > div:nth-child(2) > a > img"
    ).src = "https://uploads.scratch.mit.edu/projects/thumbnails/577749282.png";
    document.querySelector(
      "#view > div > div:nth-child(1) > div:nth-child(3) > div.box-content > div > div > div > div:nth-child(2) > div > div > a"
    ).href = "https://scratch.mit.edu/projects/577749282/";
    document.querySelector(
      "#view > div > div:nth-child(1) > div:nth-child(3) > div.box-content > div > div > div > div:nth-child(2) > div > div > a"
    ).textContent =
      "Double Rush #All #Games #Art #Music #Stories #Animations #Tutorials";
    document.querySelector(
      "#view > div > div:nth-child(1) > div:nth-child(3) > div.box-content > div > div > div > div:nth-child(2) > div > div > div > a"
    ).src = "https://scratch.mit.edu/users/Nethula_manumitha/";
    document.querySelector(
      "#view > div > div:nth-child(1) > div:nth-child(3) > div.box-content > div > div > div > div:nth-child(2) > div > div > div > a"
    ).textContent = "Nethula_manumitha";
    ...
    document.querySelector(
      "#view > div > div:nth-child(1) > div:nth-child(3) > div.box-content > div > div > div > div:nth-child(3) > a > img"
    ).src = "https://uploads.scratch.mit.edu/projects/thumbnails/582159901.png";
    document.querySelector(
      "#view > div > div:nth-child(1) > div:nth-child(3) > div.box-content > div > div > div > div:nth-child(3) > div > div > a"
    ).href = "https://scratch.mit.edu/projects/582159901/";
    document.querySelector(
      "#view > div > div:nth-child(1) > div:nth-child(3) > div.box-content > div > div > div > div:nth-child(3) > div > div > a"
    ).textContent = "300+ Game Contest Results";
    document.querySelector(
      "#view > div > div:nth-child(1) > div:nth-child(3) > div.box-content > div > div > div > div:nth-child(3) > div > div > div > a"
    ).src = "https://scratch.mit.edu/users/Nethula_manumitha/";
    document.querySelector(
      "#view > div > div:nth-child(1) > div:nth-child(3) > div.box-content > div > div > div > div:nth-child(3) > div > div > div > a"
    ).textContent = "Nethula_manumitha";
    ...
    document.querySelector(
      "#view > div > div:nth-child(1) > div:nth-child(3) > div.box-content > div > div > div > div:nth-child(4) > a > img"
    ).src = "https://uploads.scratch.mit.edu/projects/thumbnails/573896702.png";
    document.querySelector(
      "#view > div > div:nth-child(1) > div:nth-child(3) > div.box-content > div > div > div > div:nth-child(4) > div > div > a"
    ).href = "https://scratch.mit.edu/projects/573896702/";
    document.querySelector(
      "#view > div > div:nth-child(1) > div:nth-child(3) > div.box-content > div > div > div > div:nth-child(4) > div > div > a"
    ).textContent =
      "Royal Runner #All #Games #Art #Music #Stories #Animations #Tutorials";
    document.querySelector(
      "#view > div > div:nth-child(1) > div:nth-child(3) > div.box-content > div > div > div > div:nth-child(4) > div > div > div > a"
    ).src = "https://scratch.mit.edu/users/Nethula_manumitha/";
    document.querySelector(
      "#view > div > div:nth-child(1) > div:nth-child(3) > div.box-content > div > div > div > div:nth-child(4) > div > div > div > a"
    ).textContent = "Nethula_manumitha";
    ...
    document.querySelector(
      "#view > div > div:nth-child(1) > div:nth-child(3) > div.box-content > div > div > div > div:nth-child(5) > a > img"
    ).src = "https://uploads.scratch.mit.edu/projects/thumbnails/592654320.png";
    document.querySelector(
      "#view > div > div:nth-child(1) > div:nth-child(3) > div.box-content > div > div > div > div:nth-child(5) > div > div > a"
    ).href = "https://scratch.mit.edu/projects/592654320/";
    document.querySelector(
      "#view > div > div:nth-child(1) > div:nth-child(3) > div.box-content > div > div > div > div:nth-child(5) > div > div > a"
    ).textContent = "1000 Followers!! Thank You soo Much! #All ";
    document.querySelector(
      "#view > div > div:nth-child(1) > div:nth-child(3) > div.box-content > div > div > div > div:nth-child(5) > div > div > div > a"
    ).src = "https://scratch.mit.edu/users/Nethula_manumitha/";
    document.querySelector(
      "#view > div > div:nth-child(1) > div:nth-child(3) > div.box-content > div > div > div > div:nth-child(5) > div > div > div > a"
    ).textContent = "Nethula_manumitha";
  ...
  function showpasswrd() {
    ...
    el.onclick = function (event) {
      var checkedinfo = document.querySelector(
        "#navigation > div > ul > li.link.right.login-item > div > div > label:nth-child(2) > input[type=checkbox]:nth-child(1)"
      ).checked;
      if (checkedinfo === true) {
        document.querySelector("#frc-password-1088").type = "text";
        document.querySelector(
          "#navigation > div > ul > li.link.right.login-item > div > div > label"
    ...
    document
      .querySelector(
        "#navigation > div > ul > li.link.right.login-item > div > div"
      )
      .appendChild(elem);
    document
      .querySelector(
