createModal("What's New in ScratchTools v2.13.0", "This new version includes a lot of new features! We've added a sprite-specific clone counter, the ability to scroll through individual list items, a block logger, an FPS counter, and more! We've even added in some easter eggs- maybe you can find them!")
function createModal(title, description) {
var div = document.createElement('div')
    div.className = 'ReactModalPortal ScratchToolsNew'
    div.innerHTML = `<div class="ReactModal__Overlay ReactModal__Overlay--after-open modal_modal-overlay_1Lcbx"><div style="width: 50vw;" class="ReactModal__Content ReactModal__Content--after-open modal_modal-content_1h3ll prompt_modal-content_1BfWj" tabindex="-1" role="dialog" aria-label="New Variable"><div style="width: 50vw;" class="box_box_2jjDp" dir="ltr"><div class="modal_header_1h7ps"><div class="modal_header-item_2zQTd modal_header-item-title_tLOU5">${title}</div><div class="modal_header-item_2zQTd modal_header-item-close_2XDeL"></div></div><div class="prompt_body_18Z-I box_box_2jjDp"><div class="prompt_label_tWjYZ box_box_2jjDp" style="color: black;">${description}</div><center><div class="prompt_button-row_3Wc5Z box_box_2jjDp"><a href="https://scratchtools.app/discord" target="_blank" style="margin-right: 1vw;"><button class="prompt_ok-buttonScratchTools" style="color: black;"><span>Official Discord Server</span></button></a><button class="prompt_ok-button_3QFdD"><span style="color: black;">OK</span></button></div></center></div></div></div></div>`
