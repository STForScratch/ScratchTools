if (getCookie("ST Features") === undefined) {
  document.cookie = `ST Features=${
    getCookie("ST Features") + "ST "
  }; expires=Thu, 18 Dec 9999 12:00:00 UTC; path=/`;
}
...
function createFeature(name, description, id) {
  ...
  switch23.onclick = function () {
    if (this.checked === true) {
      document.cookie = `ST Features=${
        getCookie("ST Features") + this.id + " "
      }; expires=Thu, 18 Dec 9999 12:00:00 UTC; path=/`;
    } else {
      document.cookie = `ST Features=${getCookie("ST Features").replaceAll(
        this.id,
        ""
      )}; expires=Thu, 18 Dec 9999 12:00:00 UTC; path=/`;
    }
...
createFeature(
  "Sprite Hover Data",
  "In sprites on the editor, hover over the Code, Costumes, and Sounds tabs to view how many there are in each tab.",
  "sprite-hover-data"
);
...
createFeature(
  "Sidebar",
  "Adds a sidebar to the Scratch website, rather than just the normal navigation bar at the top of the screen.",
  "sidebar"
);
createFeature(
  "Recently Viewed Projects",
  "Adds a tab to the My Stuff page where you can see a list of the projects that you have recently viewed.",
  "recently-viewed-projects"
);
createFeature(
  "Round Profile Pictures",
  "All profile pictures on the Scratch website will be rounded.",
  "round-profile-pictures"
);

createFeature(
  "Compact Navbar",
  "Makes more room on the navigation bar near where your profile dropdown is.",
  "compact-navbar"
);

createFeature(
  "Unbold Site Text",
  "Makes it so that all test across Scratch is unbolded, and just normal text!",
  "unbold-forum-topics"
);
createFeature(
  "Advanced Search",
  "Easily search for users, projects, and studios with Advanced Search! (BETA)",
  "advanced-search"
);
...
description.textContent =
  "In the comments of profiles, project links will switch to their titles.";
...
function myFunction1() {
  if (switch1.checked === true) {
    document.cookie = `ST Features=${
      getCookie("ST Features") + "show-profile-titles "
    }; expires=Thu, 18 Dec 9999 12:00:00 UTC; path=/`;
  } else {
    document.cookie = `ST Features=${getCookie("ST Features").replaceAll(
      "show-profile-titles",
...
description.style.marginTop = "-20px";
description.textContent =
  "In the comments of profiles, hover over any user to view their bio.";
...
function myFunction2() {
  if (switch2.checked === true) {
    document.cookie = `ST Features=${
      getCookie("ST Features") + "hover-over-user "
    }; expires=Thu, 18 Dec 9999 12:00:00 UTC; path=/`;
  } else {
    document.cookie = `ST Features=${getCookie("ST Features").replaceAll(
      "hover-over-user",
...
description.style.marginTop = "-20px";
description.textContent =
  "View the follower count of any user on their project, right next to their username.";
...
function myFunction3() {
  if (switch3.checked === true) {
    document.cookie = `ST Features=${
      getCookie("ST Features") + "follower-count "
    }; expires=Thu, 18 Dec 9999 12:00:00 UTC; path=/`;
  } else {
    document.cookie = `ST Features=${getCookie("ST Features").replaceAll(
      "follower-count",
...
description.style.marginTop = "-20px";
description.textContent =
  "Any user's message count will be displayed on their profile.";
...
function myFunction4() {
  if (switch4.checked === true) {
    document.cookie = `ST Features=${
      getCookie("ST Features") + "message-count "
    }; expires=Thu, 18 Dec 9999 12:00:00 UTC; path=/`;
  } else {
    document.cookie = `ST Features=${getCookie("ST Features").replaceAll(
      "message-count",
...
function myFunction5() {
  if (switch5.checked === true) {
    document.cookie = `ST Features=${
      getCookie("ST Features") + "tutorials "
    }; expires=Thu, 18 Dec 9999 12:00:00 UTC; path=/`;
  } else {
    document.cookie = `ST Features=${getCookie("ST Features").replaceAll(
      "tutorials",
...
description.style.marginTop = "-20px";
description.textContent =
  "A button is added to other Scratchers' project pages that takes you to the Propose Projects to Be Featured studio.";
...
description.style.marginTop = "-20px";
description.textContent =
  "A button is added in the Scratch editor to open the project in the TurboWarp editor.";
...
function myFunction7() {
  if (switch7.checked === true) {
    document.cookie = `ST Features=${
      getCookie("ST Features") + "turbowarp "
    }; expires=Thu, 18 Dec 9999 12:00:00 UTC; path=/`;
  } else {
    document.cookie = `ST Features=${getCookie("ST Features").replaceAll(
      "turbowarp",
...
description.style.marginTop = "-20px";
description.textContent =
  "The featured project thumbnail and the profile picture have rounded corners.";
...
description.style.marginTop = "-20px";
description.textContent =
  "Adds a button that takes you to your automatic ScratchStats page.";
...
description.style.marginTop = "-20px";
description.textContent =
  "Hides the current sprite watermark on the top right corner of the editor.";
...
function myFunction10() {
  if (switch10.checked === true) {
    document.cookie = `ST Features=${
      getCookie("ST Features") + "watermark "
    }; expires=Thu, 18 Dec 9999 12:00:00 UTC; path=/`;
  } else {
    document.cookie = `ST Features=${getCookie("ST Features").replaceAll(
      "watermark",
...
description.style.marginTop = "-20px";
description.textContent =
  "Hover over any project title on a profile to view the full title, not cut off.";
...
function myFunction11() {
  if (switch11.checked === true) {
    document.cookie = `ST Features=${
      getCookie("ST Features") + "full-title "
    }; expires=Thu, 18 Dec 9999 12:00:00 UTC; path=/`;
  } else {
    document.cookie = `ST Features=${getCookie("ST Features").replaceAll(
      "full-title",
...
description.style.marginTop = "-20px";
description.textContent =
  "Adds an asterisk (*) next to the usernames of any Scratch Team member in the forums.";
...
function myFunction12() {
  if (switch12.checked === true) {
    document.cookie = `ST Features=${
      getCookie("ST Features") + "forum-asterisk "
    }; expires=Thu, 18 Dec 9999 12:00:00 UTC; path=/`;
  } else {
    document.cookie = `ST Features=${getCookie("ST Features").replaceAll(
      "forum-asterisk",
...
description.style.marginTop = "-20px";
description.textContent =
  "Adds a button to search all Scratch projects, including projects that are marked NFE.";
...
description.style.marginTop = "-20px";
description.textContent =
  "Switches the white dotted background in the editor for a plain white background.";
...
function myFunction14() {
  if (switch14.checked === true) {
    document.cookie = `ST Features=${
      getCookie("ST Features") + "editorbg "
    }; expires=Thu, 18 Dec 9999 12:00:00 UTC; path=/`;
  } else {
    document.cookie = `ST Features=${getCookie("ST Features").replaceAll(
      "editorbg",
...
description.style.marginTop = "-20px";
description.textContent =
  "Saves what you write in your forum post, and gives you the option to reuse it next time.";
...
function myFunction15() {
  if (switch15.checked === true) {
    document.cookie = `ST Features=${
      getCookie("ST Features") + "forum-draft "
    }; expires=Thu, 18 Dec 9999 12:00:00 UTC; path=/`;
  } else {
    document.cookie = `ST Features=${getCookie("ST Features").replaceAll(
      "forum-draft",
...
description.style.marginTop = "-20px";
description.textContent =
  "Replaces the Scratch News on the homepage with your recent projects.";
...
function myFunction16() {
  if (switch16.checked === true) {
    document.cookie = `ST Features=${
      getCookie("ST Features") + "scratch-news-recent "
    }; expires=Thu, 18 Dec 9999 12:00:00 UTC; path=/`;
  } else {
    document.cookie = `ST Features=${getCookie("ST Features").replaceAll(
      "scratch-news-recent",
...
description.style.marginTop = "-20px";
description.textContent =
  "Puts the ScratchTools settings button in the footer, rather than at the top of the homepage.";
...
function myFunction17() {
  if (switch17.checked === true) {
    document.cookie = `ST Features=${
      getCookie("ST Features") + "settings-footer "
    }; expires=Thu, 18 Dec 9999 12:00:00 UTC; path=/`;
  } else {
    document.cookie = `ST Features=${getCookie("ST Features").replaceAll(
      "settings-footer",
...
description.style.marginTop = "-20px";
description.textContent =
  "Opens clicked links in a new tab to make sure you do not lose your project progress.";
...
function myFunction18() {
  if (switch18.checked === true) {
    document.cookie = `ST Features=${
      getCookie("ST Features") + "open-new-tab "
    }; expires=Thu, 18 Dec 9999 12:00:00 UTC; path=/`;
  } else {
    document.cookie = `ST Features=${getCookie("ST Features").replaceAll(
      "open-new-tab",
...
description.style.marginTop = "-20px";
description.textContent =
  "Adds a button to a user's Ocular page next to their usernames in the forums.";
...
function myFunction19() {
  if (switch19.checked === true) {
    document.cookie = `ST Features=${
      getCookie("ST Features") + "ocular-link "
    }; expires=Thu, 19 Dec 9999 12:00:00 UTC; path=/`;
  } else {
    document.cookie = `ST Features=${getCookie("ST Features").replaceAll(
      "ocular-link",
      ""
...
description.style.marginTop = "-20px";
description.textContent =
  "Replaces the number input for the outline width in the color editor with a slider.";
...
function myFunction20() {
  if (switch20.checked === true) {
    document.cookie = `ST Features=${
      getCookie("ST Features") + "color-slider-input "
    }; expires=Thu, 19 Dec 9999 12:00:00 UTC; path=/`;
  } else {
    document.cookie = `ST Features=${getCookie("ST Features").replaceAll(
      "color-slider-input",
...
description.style.marginTop = "-20px";
description.textContent =
  "Hides the icons for the code, paint, and sound editors.";
...
function myFunction21() {
  if (switch21.checked === true) {
    document.cookie = `ST Features=${
      getCookie("ST Features") + "remove-editor-icons "
    }; expires=Thu, 19 Dec 9999 12:00:00 UTC; path=/`;
  } else {
    document.cookie = `ST Features=${getCookie("ST Features").replaceAll(
      "remove-editor-icons",
...
description.style.marginTop = "-20px";
description.textContent =
  "Shows a project's rating next to the project timestamp.";
...
function myFunction23() {
  ...
  if (switch23.checked === true) {
    document.cookie = `ST Features=${
      getCookie("ST Features") + "feprojectcheck "
    }; expires=Thu, 18 Dec 9999 12:00:00 UTC; path=/`;
  } else {
    document.cookie = `ST Features=${getCookie("ST Features").replaceAll(
      "feprojectcheck",
...
description.style.marginTop = "-20px";
description.textContent =
  "Puts the ScratchTools Settings button on the Account Settings page, in addition to any pages that it is already in.";
...
function myFunction25() {
  ...
  if (switch25.checked === true) {
    document.cookie = `ST Features=${
      getCookie("ST Features") + "stsettingsaccount "
    }; expires=Thu, 18 Dec 9999 12:00:00 UTC; path=/`;
  } else {
    document.cookie = `ST Features=${getCookie("ST Features").replaceAll(
      "stsettingsaccount",
...
description.style.marginTop = "-20px";
description.textContent =
  "Replaces the Account Settings button with a Settings button that leads to the same place.";
...
function myFunction24() {
  ...
  if (switch24.checked === true) {
    document.cookie = `ST Features=${
      getCookie("ST Features") + "accountsettings "
    }; expires=Thu, 18 Dec 9999 12:00:00 UTC; path=/`;
  } else {
    document.cookie = `ST Features=${getCookie("ST Features").replaceAll(
      "accountsettings",
