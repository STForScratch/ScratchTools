...
document.querySelector(".option[data-option=discord]").addEventListener("click", function() {
    chrome.tabs.create({
        url: "https://discord.gg/TcgexZDypB"
    })
})

document.querySelector(".option[data-option=twitter]").addEventListener("click", function() {
    chrome.tabs.create({
