if (
    ...
    document.querySelector("#content").style.width = "84%";
...
async function createMenu(name, href, imageLink, id) {
    ...
    create.onclick = () => {window.location.href = href};
    if (id == "top") {
        ...
        create2.onclick = () => {location.href = "/messages"};
        ...
        create3.onclick = () => {location.href = "/mystuff"};
