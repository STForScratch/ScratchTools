if (window.location.href.startsWith('https://scratch.mit.edu/projects/') && window.location.href.includes('/editor')) {
    function checkForNavForTurbowarp() {
        if (document.querySelector('div.scratchtoolsTurbowarp') === null) {
            if (document.querySelector('.menu-bar_main-menu_3wjWH') !== null) {
                ...
                outerDiv.className = 'menu-bar_menu-bar-item_oLDa- scratchtoolsTurbowarp'
                var a = document.createElement('a')
                a.href = window.location.href.replace('https://scratch.mit.edu/projects/', 'https://turbowarp.org/')
                ...
                img.draggable = false
                img.src = 'https://dashboard.snapcraft.io/site_media/appmedia/2021/02/512x512_Q3PveGU.png'
    ...
    waitForNavForTurbowarp.observe(document.querySelector('body'), {attributes: true,childList: true,subtree: true});
}