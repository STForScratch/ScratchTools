...
document.querySelector('.input_input-form_l9eYg.project-title-input_title-field_en5Gd.menu-bar_title-field-growable_3qr4G').style.marginLeft = '0.2rem'
document.querySelector('.input_input-form_l9eYg.project-title-input_title-field_en5Gd.menu-bar_title-field-growable_3qr4G').style.marginRight = '0.2rem'
document.querySelector('.input_input-form_l9eYg.project-title-input_title-field_en5Gd.menu-bar_title-field-growable_3qr4G').style.color = 'hsla(225, 15%, 40%, 1) !important'
document.querySelector('.blocklyFlyout').width = '300'

document.querySelector('.blocklyFlyout').transform = null

document.querySelector('.menu-bar_scratch-logo_2uReV.menu-bar_clickable_1g3uo').src = 'https://raw.githubusercontent.com/LLK/scratch-flash/develop/src/assets/UI/topbar/scratchlogoOff.png'
document.querySelector('.menu-bar_menu-bar-item_oLDa-.menu-bar_growable_1sHWN').style.display = 'none'
    } catch(err) {}
}
}
var waitForEditorNavBarForTwo = new MutationObserver(addOtherAttributes);
waitForEditorNavBarForTwo.observe(document.querySelector('body'), { attributes: true, childList: true, subtree: true });
}