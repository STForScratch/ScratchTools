if (window.location.href.includes("https://scratch.mit.edu/projects/")) {
  if (window.location.href.includes("editor")) {
    function checkFlag2() {
      if (
        document.querySelector(
          "#app > div > div.gui_menu-bar-position_3U1T0.menu-bar_menu-bar_JcuHF.box_box_2jjDp > div.menu-bar_main-menu_3wjWH > div:nth-child(7)"
        ) === null
      ) {
    ...
    function editor() {
      ...
      document
        .querySelector(
          "#app > div > div.gui_menu-bar-position_3U1T0.menu-bar_menu-bar_JcuHF.box_box_2jjDp"
        )
        .appendChild(element);
      ...
      document
        .querySelector(
          "#app > div > div.gui_menu-bar-position_3U1T0.menu-bar_menu-bar_JcuHF.box_box_2jjDp > a"
        )
        .appendChild(clone);
      document.querySelector(
