function addKeyPressed() {
  ...
  if (document.querySelector("div.scratchtools.key") === null) {
    ...
    ScratchTools.Scratch.vm.runtime.on("KEY_PRESSED", function (el) {
      if (document.querySelector("div.scratchtools.key") !== null) {
        document.querySelector("div.scratchtools.key").textContent =
          "Last Key Pressed: " + el;
      }
    });
  }
...
`;
  if (document.querySelector("div.scratchtools.navlastkey") === null) {
    ...
    ScratchTools.Scratch.vm.runtime.on("KEY_PRESSED", function (el) {
      if (document.querySelector("div.scratchtools.navlastkey") !== null) {
        document
          .querySelector("div.scratchtools.navlastkey")
          .querySelector("span").textContent = "Last Key Pressed: " + el;
      }
    });
  }
}
if (window.location.href.startsWith("https://scratch.mit.edu/projects/")) {
  ...
  if (document.querySelector("div.scratchtools.navlastkey") === null) {
    if (document.querySelector("div.gui") !== null) {
      document.querySelector("div.gui").childNodes.forEach(function (el) {
        if (
          el.className.startsWith("gui_menu-bar-position") &&
